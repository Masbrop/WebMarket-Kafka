package com.johancas.WebmarketKafka.models;

import java.util.Map;

public record EventoAWSSqs(Map<String, com.amazonaws.services.sqs.model.MessageAttributeValue> attributeValueMap) implements IEventoInterno {
